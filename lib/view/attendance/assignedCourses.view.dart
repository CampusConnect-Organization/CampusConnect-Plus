...
import 'package:campus_connect_plus/view/attendance/mark_attendance.view.dart';
...
class AssignedCoursesView extends StatefulWidget {
  const AssignedCoursesView({Key? key}) : super(key: key);
